...
where information structure is critical.
...
$\exists T < \infty, \exists \rho(t)$ decreasing and upper-bounded by $2\Delta$ for all $t \ge T$
such that $\bar{\sigma}^t_m(\delta,\tth)$ is a $(\rho(t))$-equilibrium strategy. 
