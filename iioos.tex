...
by sampling from $\sigma_c(\tth)$, and who reveals $I(\tth)$ to $P(\tth)$ on their turn. The players play until the match is terminated, declaring one
the winner. Often, many matches are played for results to be statistically significant.
