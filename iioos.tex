...
OOS         & 1s   & 0.32  & 0.44  & 0.76 \\
\hline
ISMCTS(mix) & 5s   & 0.23  & 0.57  & 0.80  \\
OOS         & 5s   & 0.17  & 0.29  & 0.46  \\
%\hline
...
ISMCTS(max)   & 5s   &        &        &       \\
ISMCTS(mix)   & 5s   &        &        &       \\
OOS           & 5s   & 0.229  & 0.295  & 0.524 \\
\end{tabular}
\caption{LD(1,1) exploitability using full-stitching method. \mlnote{5 second strategies are now generated. Results coming soon.}} 
\end{center}
\end{table}
