...
two other methods: a the \defword{partial stitching} method which does the same as full stitching to a fixed depth from the root, except also 
...
OOS         & 25s   &       &       &       \\
\end{tabular}
\caption{LD(1,1) exploitability using single-match method.}
\end{center}
\end{table}
