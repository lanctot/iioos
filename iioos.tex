...
\item Information Set Search~\cite{Parker06paranoia}\vlnote{\cite{Parker10iss} is a little more detailed, but I guess it is from a less reputable forum.} We have used ISS in MCTS setting in a visibility-based pursuit-evasion game~\cite{Lisy12peg}
...
\item MCTS in Kriegspiel~\cite{Ciancarini09Kriegspiel}\vlnote{why not the AIJ 2010 paper?}
