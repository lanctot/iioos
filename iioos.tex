...
from previous search in the same match. PST is less affected than IST by the targetung and appears to have lower exploitability. 
...
PST($\delta = 0.8$) against ISMCTS in LD(2,2). PST won 256 of these, showing a competitive promise
