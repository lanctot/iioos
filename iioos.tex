...
a the \defword{multi-match} method, which simulates several matches between the algorithms saving the values from searches starting
at information sets $I$ encountered along the matches, combining the values those $I$ which are encountered several times across the 
matches. Any information sets that are not reached play uniform random. 
...
\hline
ISMCTS(max) & 1s   & 0.795 & 0.767 & 1.562 \\
...
% Full stitching, 1 second:  ./stitching scratch/iss.initial.dat 2 2 br 
% OOS 
%Done. v1 (br to fixed p2) = 0.288687
%Done. v2 (br to fixed p1) = 0.394711
% total = 0.683398
%
% ISMCTS
% Done. v1 (br to fixed p2) = 0.795492
% Done. v2 (br to fixed p1) = 0.765997
% 

%Done. v1 (br to fixed p2) = 0.562958
%Done. v2 (br to fixed p1) = 0.249643
