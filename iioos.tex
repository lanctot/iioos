...
leading to a sequence of states and actions describing an interation. There is some amount of initial time %$T_{prep}$, 
...
%where resulting strategies have competed at the human expert level and have been the basis of several successful computer poker competition 
%agents. 
...
%as evidenced by events such the as defeat of human chess champions, 
